...
//2 초	128 MB	211139	78325	46526	36.062%
//문제
...
fun main(args: Array<String>) = with(System.`in`.bufferedReader()) {
    ...
    val solution = Solution1260(n,arr,v)
    print(solution.sb.toString())
}

class Solution1260(val n: Int,val arr: Array<BooleanArray>, v: Int) {
