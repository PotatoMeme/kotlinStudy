...
//1 초	128 MB	3559	1484	1233	42.342%
//문제
...
fun main() = with(System.`in`.bufferedReader()) {
    ...
    for (i in 1 until matchResults.count()) {
        sb.append(matchResults[0].value)
        val (a, b) = matchResults[i].destructured
        sb.append(b.reversed().replace("][", "[]"))
            .append(" ")
            .append(a)
            .appendLine(';')
    }
