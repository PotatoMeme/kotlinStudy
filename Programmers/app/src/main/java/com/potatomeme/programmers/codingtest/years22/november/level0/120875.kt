package com.example.myapplication.level0
...
// ((dots[0][0] - dots[1][0]) / (dots[0][1] - dots[1][1])) == ((dots[2][0] - dots[3][0]) / (dots[2][1] - dots[3][1]))
// 0을 나누면 오류가 발생할수도 있음
// ((dots[0][0] - dots[1][0]) * (dots[2][1] - dots[3][1])) == ((dots[2][0] - dots[3][0]) * (dots[0][1] - dots[1][1]))
